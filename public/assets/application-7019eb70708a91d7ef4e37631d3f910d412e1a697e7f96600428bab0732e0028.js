...
(function() { this.JST || (this.JST = {}); this.JST["bookings/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Make a Request</h2>\n<input type="hidden" name="booking[tour_id]" value="',  tour.escape('id'),'">\n<div class = \'date-picker\'></div>\n<button type="button btn-primary" class=\'submit-booking btn btn-primary\'>Request Booking</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["bookings/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>My Reservations</h1>\n<table class=" table table-hover bookings-index-items">\n\n</table>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["bookings/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <td> ',  booking.escape('tour_id') ,'</td>\n  <td> ',  booking.escape('tour_name'),', ', booking.escape('tour_city'),'</td>\n  <td>',  booking.escape('tour_date'),'</td>\n  <td>',  booking.escape('status') ,'</td>\n    ');  if (booking.escape('status') !== "cancelled") { ; __p.push('\n      <td><button type="button" class="cancel-btn btn-primary" >Cancel</button></td>\n    ');  } ; __p.push('\n  </form>\n\n  </td>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["destinations/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="jumbotron">\n  <h1>Explore like a local</h1>\n  <p>...</p>\n  <div class="search">\n    <input type="text"\n      class=\'search-box\'\n      name="destination[name]">\n    <p><a class="btn btn-primary btn-lg" href="#" role="button">Search</a></p>\n    <div class="search-results"></div>\n  </div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["destinations/search_results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- <div class=\'search-results\'> -->\n  ');  places.each( function(place) { ; __p.push('\n    <a href="#/destinations/', place.escape('id'),'">\n      <div class=\'search-name\'>', place.escape('name'),'</div>\n    </a>\n  ');   }) ; __p.push('\n<!-- </div> -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["destinations/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>', place.escape('name'),'</h1>\n\n<h4>Tours</h4>\n<div class="tours">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["images/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4>Add Photos</h4>\n<button class="upload-button btn btn-default">Upload</button>\n<div class="images">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["images/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img src="', image.escape('url'),'" alt="" />\n<button type="button" class=\'btn btn-danger\' name="button">Delete</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["nav_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="navbar navbar-default">\n  <div class="container-fluid">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class="navbar-header">\n      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <a class="navbar-brand" href="#">Tryable</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n      <ul class="nav navbar-nav">\n      </ul>\n      <!-- <form class="navbar-form navbar-left" role="search">\n        <div class="form-group">\n          <input type="text" class="form-control search-box" placeholder="Search">\n        </div>\n        <div class="search-results">\n        </div>\n        <button type="submit" class="btn btn-default">Search</button>\n      </form> -->\n      <ul class="nav navbar-nav navbar-right">\n          <li><a href="#">About</a></li>\n        ');  if (Tryable.CURRENT_USER === undefined) { ; __p.push('\n          <li><a href="/users/new">Sign Up</a></li>\n          <li><a href="session/new">Sign In</a></li>\n\n        ');  } else { ; __p.push('\n          <li><a href="#/tours/new">List an Experience</a></li>\n          <li class="dropdown">\n            <a href="#" class="dropdown-toggle"\n              data-toggle="dropdown"\n              role="button"\n              aria-haspopup="true"\n              aria-expanded="false">\n              Hi ', Tryable.CURRENT_USER.username ,'\n              <span class="caret"></span>\n            </a>\n            <ul class="dropdown-menu">\n              <li><a href="#">Profile</a></li>\n              <li><a href="#/bookings">Reservations</a></li>\n              <li role="separator" class="divider"></li>\n              <li>\n                <form action="/session" method="post">\n                  <input type="hidden" name="authenticity_token" value="', Tryable.AUTH_TOKEN,'">\n                  <input type="hidden" name="_method" value="delete">\n                  <input type="submit" value="Logout">\n                </form>\n              </li>\n            </ul>\n          </li>\n        ');  } ; __p.push('\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tours/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>List Your Experience</h2>\n<form class="new-tour">\n  <select name="tour[destination_id]">\n    ');  places.each( function(place) { ; __p.push('\n      <option value="', place.escape('id'),'">', place.escape('name'),'</option>\n    ');  }); ; __p.push('\n  </select>\n\n  <label>Title\n    <input type="text" name="tour[title]">\n  </label>\n  <label>Description\n    <textarea name="tour[description]"></textarea>\n  </label>\n\n  <label>Price\n    <input type="number" name="tour[price]">\n  </label>\n\n  <button type="button btn-primary" class=\'submit-booking btn btn-primary\'>Save</button>\n</form>\n\n<div class="image-upload">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tours/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="col-md-3">\n</div>\n\n<div class="tour-show col-md-6">\n  <h1>', tour.escape('title'),'</h1>\n  <p>\n    ', tour.escape('description'),'\n  </p>\n  <a href="#/destinations/', tour.get('destination_id'),'">Back</a>\n\n  <div class="photos-index">\n  </div>\n  \n</div>\n\n\n<div class="booking-form col-md-3">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tours/tour_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#/tours/', tour.escape('id'),'">\n  <h4 class=\'tour-title\'>', tour.escape('title'),'</h4>\n  <p>\n    ', tour.escape('description'),'\n  </p>\n</a>\n');}return __p.join('');};
}).call(this);
